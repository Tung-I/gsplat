...
class Runner:
    ...
    @torch.no_grad()
    def render_traj(self, step: int, frames: bool = False) -> None:
        ...
        video_path = f"{video_dir}/traj_{cfg.render_traj_path}_{step}.mp4"
        ...
        for i in tqdm.trange(len(camtoworlds_all), desc="Rendering trajectory"):
            ...
            # print rendres[0].requires_grad
            print(f"renders: {renders.requires_grad}")
            raise Exception
...
if __name__ == "__main__":
    ...
    cfg.ckpt = [f"{cfg.result_dir}/ckpts/ckpt_29999_rank0.pt"]
